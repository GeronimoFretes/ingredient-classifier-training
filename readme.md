...
2. **Filtering and reranking**  
   Candidate images are filtered through caption rules and reranked with **CLIP** to keep more relevant training examples.
...
├── src/
│   ├── build_dataset.py      # Image retrieval + filtering + CLIP reranking
